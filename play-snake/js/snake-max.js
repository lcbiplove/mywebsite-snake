    ...
    */
    return function(config) {
        ...
        function handleEndCondition(handleFunc) {
            ...
            isDead = true;
            var dead_audio = new Audio('audio/dead.mp3');
            dead_audio.play();
            handleFunc();
        }
        ...
        */
        me.eatFood = function() {
            ...
            var eat_audio = new Audio('audio/eat.mp3');
            eat_audio.play();
            return true;
        };
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmHighscorePanel.innerHTML = "Highscore: " + ((typeof localStorage.jsSnakeHighScore === 'undefined' || localStorage.jsSnakeHighScore == 0)  ? 1 : localStorage.jsSnakeHighScore);
        ...
        */
        ...
        if(getCookie("ck__th")==="null"){
            changeTheme('css/dark-theme.css?' + Math.random());
            document.querySelector("#select option:last-child").setAttribute("selected", "");
            document.querySelector("#select option:first-child").removeAttribute("selected");
        }
